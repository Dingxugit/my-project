...
import {page,getDcyhList} from "@/services/swy/dcyh";
import DcyjglModal from "./components";
...
const Dcyhgl = () =>{
  ...
  const handleExport = async () => {
    ...
    const option = {};
    option.fileName = `${dept.name}单车油耗考核卡片`;
    option.datas = [
      {
        sheetData: sheetDataList,
        sheetFilter: [
          'year','yuefen', 'yongyoudanwei', 'chepaihaoma', 'youpin', 'leixing', 'pinpai','pailiang',
