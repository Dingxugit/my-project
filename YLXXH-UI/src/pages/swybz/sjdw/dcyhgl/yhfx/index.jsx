...
import {pageEjdwYhfx} from "@/services/swy/dcyh";
...
const Dcyhgl = () =>{
  ...
  const columns = [
    { title: '时间', dataIndex: 'sj',hidden: true,
    ...
    { title: '单位名称', dataIndex: 'yongyoudanwei',hideInSearch : true},
    { title: '类型', dataIndex: 'leixing' },
    { title: '车牌号', dataIndex: 'chepaihaoma',},
    ...
    { title: '执行标准（升/百公里）', dataIndex: 'zhixingbiaozhun' ,hideInSearch : true,render: (text, record,index) => {
