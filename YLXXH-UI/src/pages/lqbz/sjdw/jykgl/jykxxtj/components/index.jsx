...
import {save, update} from "@/services/lqbz/jykgl/jykxxtj";
                ...
                return (
                  <FormItem name="photo">
                    <Upload
                      ...
                      action="/zxHealth/t/lqbz/jykxxtj/uploadPhoto"
                    ...
                    >
                      {
                        getFieldValue('photo') ?
                          <img src={`/assets/lqbz/${form.getFieldValue('photo')}`} alt="avatar" /> :
