...
import {save, update,getLastCzpzBycarnum} from "@/services/lqbz/jygl";
...
const YlgyczpzModal = (props) =>{
  ...
  const okHandle = async () => {
    ...
    fieldsValue.chongzhisj = fieldsValue.chongzhisj.format(dateFormat) ;
  ...
  return (
    <Modal
      ...
      destroyOnClose
      title={jyId ? '修改油料供应充值凭证信息' : '新建油料供应充值凭证信息'}
    ...
    >
      <Form
        initialValues={{
          chongzhisj: values.chongzhisj ? moment(values.chongzhisj) : moment(new Date())
