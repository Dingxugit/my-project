...
import {page} from "@/services/ylshh/jykgl/xxtj";
import ShhJykxxtjModal from "./components";
import {PageHeaderWrapper} from '@ant-design/pro-layout';
import ProTable from '@ant-design/pro-table';
import {Button} from 'antd';
import ExportJsonExcel from "js-export-excel"
import {getJykxxtjList} from "@/services/ylshh/jykgl/xxtj";
import PicModal from "@/pages/lqbz/sjdw/jykgl/jykxxtj/components/PicModal";
...
const Jykxxtj = () =>{
  ...
  const columns = [
    { title: '加油卡卡号', dataIndex: 'jiayoukahao'},
    ...
    { title: '车架号', dataIndex: 'chejiahaoma' ,hideInSearch : true},
  ...
  const handleExport = async () => {
    ...
    const option = {};
    option.fileName = `${dept.name}加油卡信息统计表`;
    option.datas = [
      {
        sheetData: sheetDataList,
        sheetFilter: [
          'bianzhidanwei','jiayoukahao', 'numberplate', 'changpaixinghao', 'fadongjihao', 'chejiahaoma',
  ...
  const handleExportPic = async () =>{
    fetch('/zxHealth/t/shh/file/exportPic', { // downloadFiles 接口请求地址
      method: 'POST',
      headers: new Headers({
